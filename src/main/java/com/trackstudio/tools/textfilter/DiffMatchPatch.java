...
public class DiffMatchPatch {
    ...
    // Defaults.
    // Set these on your com.action.diff_match_patch instance to override the defaults.
     ...
     */
    public final int Diff_DualThreshold = 32;
    /**
    ...
    protected static class LinesToCharsResult {
        ...
        protected final CopyOnWriteArrayList<String> lineArray;

        protected LinesToCharsResult(String chars1, String chars2,
                                     List<String> lineArray) {
            this.chars1 = chars1;
            this.chars2 = chars2;
            this.lineArray = new CopyOnWriteArrayList(Null.removeNullElementsFromList(lineArray));
        }
    }
