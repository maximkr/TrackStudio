...
<div class="ts-admin-header ts-admin-header--user-workflow" id="customHeader">
    <div class="ts-admin-header__inner">
        ...
        <c:if test="${currentPrstatus ne null}">
            <html:link styleClass="ts-admin-header__current"
        ...
        <span class="ts-admin-header__separator">/</span>
        <html:link styleClass="ts-admin-header__crumb"
