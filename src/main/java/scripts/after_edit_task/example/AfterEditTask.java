package scripts.after_edit_task.example;
 ...
 */
public class AfterEditTask implements TaskTrigger {
    private static final Logger log = LoggerFactory.getLogger(AfterEditTask.class);

    @Override
    public SecuredTaskTriggerBean execute(SecuredTaskTriggerBean task) throws GranException {
        log.info("AfterEditTask script example");
        // here your actions
        return task;
    }
}
