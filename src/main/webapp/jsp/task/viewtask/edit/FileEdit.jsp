...
<tiles:insert page="/jsp/layout/ListLayout.jsp" flush="true">
    ...
    <tiles:put name="main" type="string">
        <c:if test="${canEdit}">
            <div>
            <html:form method="POST" enctype="multipart/form-data" action="/TaskEditAction" styleId="checkunload" onsubmit="if (validate(this)) {showButton(true); return true;} else {return false}">
                <table width="100%">
                    <tr>
                        <td width="60%">
                            <div class="caption" style="display:inline;border-color:#FFFFFF; font-size: 20px; background-color:#FFFFFF"></div>
                            <html:text styleId="name" style="font-size: 20px;width:60%;" property="name" maxlength="200" alt=">0"/>
                        </td>
                        <td width="40%" style="float:right;">
                            <input type="submit" class="iconized" value="<I18n:message key="SAVE" />" name="SAVE" disabled="true"/>
                            <html:button styleClass="iconized secondary"  property="cancelButton" disabled="true" onclick="showButton(true); document.location='${referer}';">
                        ...
                        <%--<tr>--%>
                            <%--<td id="upload">--%>
                                <%--<div>--%>
                                    ...
                                    <%--<br>--%>
                                    <%--<input type="text" id="filedesc0" size="80" name="filedesc[0]"/>--%>
                                <%--</div>--%>
                            <%--</td>--%>
                        <%--</tr>--%>
                    <%--</table>--%>
