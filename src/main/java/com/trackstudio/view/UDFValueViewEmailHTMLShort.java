...
@Immutable
public class UDFValueViewEmailHTMLShort extends UDFValueViewEmailHTML {
    public UDFValueViewEmailHTMLShort(SecuredUDFValueBean udfValue) {
        super(udfValue);
    }
        ...
        if (null != va) {
            ...
            switch (udfValue.getUdfType()) {
                case UdfValue.DATE:
                    ...
                    return "<pre style=\"white-space: nowrap\">" + value + "</pre>";
                case UdfValue.FLOAT:
                ...
                case UdfValue.TASK: {
                    ...
                    for (Iterator<SecuredTaskBean> it = set.iterator(); it.hasNext();) {
                        ...
                        TaskView v = new TaskListViewEmailHTML(t);
                        if (it.hasNext()) {
                            r += v.getNumber() + "<br>";
                        } else {
                            r += v.getNumber();
