...
<script type="text/javascript">
	...
	function deleteUser() {
		if (confirm("<I18n:message key="DELETE_USER_REQ"><c:out value="${currentUser.name}" escapeXml="true"/></I18n:message>") == true)location.replace("<c:out value="${contextPath}/UserListAction.do?deleteButton=true&amp;method=deleteUsers&amp;id=${currentUser.id}&amp;SELUSER=${currentUser.id}" escapeXml='false'/>");
	}
