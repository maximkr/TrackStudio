 ...
 * bean, you can standardize this using wrappers. Some of these
...
public interface Sync {
  ...
  **/
  ...
  public static final long ONE_YEAR = (long)(365.2425 * (double) ONE_DAY);

  /**  One century in milliseconds; convenient as a time-out value **/
  public static final long ONE_CENTURY = 100L * ONE_YEAR;
