...
# Upgrading the minor versions (4.0.x)
...
4. Copy the entire content of directories etc, where the files like **property**, scripts, templates etc are stored into the analogous directory in the new version.
