...
<tiles:insert page="/jsp/layout/ListLayout.jsp" flush="true">
    ...
    <tiles:put name="main" type="string">
        <div class="nblueborder">
            ...
            <div class="indent">
                <html:form method="POST" action="/UserUdfMTypeSecurityAction" styleId="checkunload"
                    ...
                    <div class="blueborder">
                        ...
                        <div class="indent">
                            <table class="allowdeny">
                                ...
                                <tr>
                                    <td>
                                        <html:select property="cannotview" multiple="true" size="10"
                                                     styleClass="monospaced fixedwidth">
                                            <c:forEach items="${canNotViewList}" var="s">
                                                <option value="${s.key}"><c:out value="${s.value}"/></option>
                                            </c:forEach>
                                        </html:select>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <html:select property="canview" multiple="true" size="10"
                                                     styleClass="monospaced fixedwidth">
                                            <c:forEach items="${canViewList}" var="s">
                                                <option value="${s.key}"><c:out value="${s.value}"/></option>
                                            </c:forEach>
                                        </html:select>
                                    </td>
                                ...
                                <c:if test="${!isUser}">
                                    <tr>
                                        <td colspan="2"></td>
                                        <td>
                                            <input type="button" class="iconized" name="hanlder" id="canviewhandler"
                                                   onclick="setOptions(this.form, 'cannotview', 'canview','<I18n:message key="HANDLER"/>'); return false;"
                                                   value="<I18n:message key="HANDLER"/>"> <label
                                                for="canviewhandler"><I18n:message key="HANDLER_ONLY"/></label><br>
                                            <input type="button" class="iconized" name="submitter" id="canviewsubmitter"
                                                   ...
                                                   value="<I18n:message key="SUBMITTER"/>"> <label
                                                for="canviewsubmitter"><I18n:message key="SUBMITTER_ONLY"/></label><br>
                                            <input type="button" class="iconized" name="all" id="canviewall"
                                                   onclick="resetOptions(this.form, 'cannotview', 'canview'); return false;"
                                                   value="<I18n:message key="ALL"/>"> <label
                                                for="canviewall"><I18n:message key="ALL"/></label><br>
                                        </td>
                                    </tr>
                                </c:if>
                            </table>
                            <input type="hidden" name="hiddencanview" value="${canview}">
                        </div>
                    </div>
                    <br>
                    ...
                    <div class="blueborder">
                        ...
                        <div class="indent">
                            <table class="allowdeny">
                                ...
                                <tr>
                                    <td>
                                        <html:select property="cannotedit" multiple="true" size="10"
                                                     styleClass="monospaced fixedwidth">
                                            <c:forEach items="${canNotEditList}" var="s">
                                                <option value="${s.key}"><c:out value="${s.value}"/></option>
                                            </c:forEach>
                                        </html:select>
                                    </td>
                                    ...
                                    <td>
                                        <html:select property="canedit" multiple="true" size="10"
                                                     styleClass="monospaced fixedwidth">
                                            <c:forEach items="${canEditList}" var="s">
                                                <option value="${s.key}"><c:out value="${s.value}"/></option>
                                            </c:forEach>
                                        </html:select>
                                    </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="button" class="iconized" name="handler" id="canedithandler"
                                                   ...
                                                   value="<I18n:message key="HANDLER"/>"> <label
                                                for=canedithandler><I18n:message key="HANDLER_ONLY"/></label><br>
                                            <input type="button" class="iconized" name="submitter" id="caneditsubmitter"
                                                   ...
                                                   value="<I18n:message key="SUBMITTER"/>"> <label
                                                for="caneditsubmitter"><I18n:message key="SUBMITTER_ONLY"/></label><br>
                                            <input type="button" class="iconized" name="all" id="caneditall"
                                                   onclick="resetOptions(this.form, 'cannotedit', 'canedit'); return false;"
                                                   value="<I18n:message key="ALL"/>"> <label
                                                for="caneditall"><I18n:message key="ALL"/></label><br>
                                        </td>
                                    </tr>
                                </c:if>
                            </table>
                            <input type="hidden" name="hiddencanedit" value="${canedit}">
                        </div>
                    </div>
