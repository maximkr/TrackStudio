...
/**
 * This class has methods for converting text from HTML and back
 */
@Immutable
public class AccentedFilter {
    ...
    private static ConcurrentMap<String, String> quickRevEntities = new ConcurrentHashMap<String, String>(ENTITIES.length);
    ...
    /**
     * This method escapes text from HTML
     *
     * @param nonHTMLsrc HTML text
     * @return String escaped HTML text
     */
    public static StringBuffer escape(StringBuffer nonHTMLsrc) {
        StringBuffer res = new StringBuffer();
        int l = nonHTMLsrc.length();
        for (int i = 0; i < l; i++) {
            char c = nonHTMLsrc.charAt(i);

            if (c == 171 || c == 187) { // this char not be escape
                continue;
            }
    ...
    /**
     * This method un escapes StringBuffer from escaped text
     *
     * @param HTMLsrc escaped text
     * @return String html text
     */
    public static StringBuffer unescape(StringBuffer HTMLsrc) {
        if (HTMLsrc == null) {
            return null;
        }
        ...
        while (HTMLsrc.length() > 0) {
            ...
            if (j == -1) {
                ...
                HTMLsrc = new StringBuffer(HTMLsrc.substring(i + 1));
                continue;
            }
            ...
            if (decodedEntity == null) {
                if (entity.startsWith("#")) {
                    ...
                    HTMLsrc = new StringBuffer(HTMLsrc.substring(j + 1));
                } else {
                    res.append(HTMLsrc.substring(0, i)).append('&');
                    HTMLsrc = new StringBuffer(HTMLsrc.substring(i + 1));
                }
    ...
    /**
     * This is main method for testing aims
     *
     * @param args enter params
     */
    public static void main(String[] args) {
        String ar = args[0];
        System.out.println(unescape(new StringBuffer(ar)));
    }
}