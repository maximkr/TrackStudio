package com.trackstudio.common;
...
public class FieldMap {
    ...
    public static final ConcurrentMap<String, String> allFields = new ConcurrentHashMap<String, String>();
    ...
    public static final FieldMap LAST_MSG_SUBMITDATE = new FieldMap(55,"LAST_MESSAGE_DATE", "lst_msg_date", "lst_msg_submitdate");
    ...
    public static final FieldMap USER_TEMPLATE = new FieldMap(53, "USER_TEMPLATE", "template", "user_template");
    public static final FieldMap USER_PASSWORD = new FieldMap(40, "USER_PASSWORD", "password", "user_password");
    public static final FieldMap DEEP_SEARCH = new FieldMap(54, "SUBTASK", "subtask", "subtask");
    ...
    static {
        ...
        taskFields.add(LAST_MSG_SUBMITDATE);
