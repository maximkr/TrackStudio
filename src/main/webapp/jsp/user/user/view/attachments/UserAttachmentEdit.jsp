...
<tiles:put name="customHeader" value="/jsp/user/user/view/attachments/UserAttachmentHeader.jsp"/>
...
<table class="general" cellpadding="0" cellspacing="0">
        ...
        <tr>
            ...
            <td>
                <html:text property="name" size="50" maxlength="200" alt=">0"/>
            </td>
        </tr>
        <tr>
            <th><I18n:message key="DESCRIPTION"/></th>
            <td>
                <html:text property="description" size="50" maxlength="200"/>
            </td>
        </tr>
        <tr>
